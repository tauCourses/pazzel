...
#define MISSING_CORNER "Cannot solve puzzle: missing corner element: "
#define NOT_SQUARE_PIECE "Piece is not square"
#define NOT_ENOUGH_CORNERS "There are not enough corners"
